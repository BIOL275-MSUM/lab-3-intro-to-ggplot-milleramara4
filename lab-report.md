...
I chose to make a histogram in part (A). A histogram displays the
frequency distribution of a numerical variable.

> C. Describe the shape of the frequency distribution. What are its main
> features?

The histogram seems to have a sort of bell shape with one outlier on the
right. It looks like it is unimodel also.
...
There are 10,721 bird species in the new birds dataset. I looked at the
birds data and did a count on the scientific name and saw that there
were 10,721 rows of data.
...
I used the code, count(birds, order), to determine that there are 41
different orders after I noticed that there are 41 rows of data.
...
I created a bar chart because the order of birds represents a
categorical value and that is best shown with a bar chart.

## Links to peer review

I reviewed MaryJo Nelson’s lab report at this URL:
<https://github.com/BIOL275-MSUM/lab-3-intro-to-ggplot-MaryJo-Nelson>

MaryJo Nelson reviewed my lab report at this URL:
<https://github.com/BIOL275-MSUM/lab-3-intro-to-ggplot-milleramara4>
